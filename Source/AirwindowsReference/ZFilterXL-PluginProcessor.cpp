/*
================================================================================
Z-FILTER XL - AIRWINDOWS DSP REFERENCE COPY
================================================================================
This is a reference-only copy of the Z-Filter XL (v2-xl branch) PluginProcessor.cpp.
NOT compiled — kept alongside FilterReference.h for documentation purposes.

Airwindows sources used:
  - ZLowpass2  (LP coefficients, clip factor, cascaded biquads, opamp chain)
  - ZHighpass2 (HP coefficients)
  - ZBandpass2 (BP coefficients, clip factor)
  - ZNotch2    (Notch coefficients, golden ratio Q)
  - ZRegion2   (5-stage spread-frequency bandpass with sine waveshaping)
  - ZOutputStage (opamp chain, aggressive input/output gain curves)

Features: 5 filter types (LP/HP/BP/NT/Region), dual independent filters
          (A+B) with series/parallel routing, morph (coefficient blend +
          Region crossfade + per-filter poles interpolation), 3 LFOs
          (LFO A, LFO B with link, Morph LFO with sync), ZOutputStage
          toggle, independent poles per filter.
================================================================================
*/
