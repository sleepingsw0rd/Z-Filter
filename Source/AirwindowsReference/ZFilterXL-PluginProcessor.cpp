...
Features: 4 filter types (LP/HP/BP/NT), dual independent filters
          (A+B) with series/parallel routing, morph (coefficient blend +
          per-filter poles interpolation), 3 LFOs (LFO A, LFO B with
          link, Morph LFO with sync), ZOutputStage toggle, independent
          poles per filter.
================================================================================
*/
...
void ZFilterProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
    ...
    computeFilterCoeffs(filterTypeA, (double)B, (double)polesAParam,
        biquadA, biquadB, biquadC, biquadD,
    ...
    computeFilterCoeffs(filterTypeB, (double)B, (double)polesBParam,
        biquadA2, biquadB2, biquadC2, biquadD2,
