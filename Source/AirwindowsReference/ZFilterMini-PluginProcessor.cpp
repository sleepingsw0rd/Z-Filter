/*
================================================================================
Z-FILTER MINI - AIRWINDOWS DSP REFERENCE COPY
================================================================================
This is a reference-only copy of the Z-Filter Mini PluginProcessor.cpp.
...
Features: 4 filter types (LP/HP/BP/NT), 4 cascaded biquad stages,
          opamp stage (always on), TPDF dither, per-block interpolation.
No LFO, no morph, no Region, no ZOutputStage toggle.
================================================================================
*/
