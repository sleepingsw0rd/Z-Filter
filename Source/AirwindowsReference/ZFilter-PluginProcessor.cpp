/*
================================================================================
Z-FILTER (MAIN) - AIRWINDOWS DSP REFERENCE COPY
================================================================================
This is a reference-only copy of the Z-Filter (main branch) PluginProcessor.cpp.
...
Features: 5 filter types (LP/HP/BP/NT/Region), morph (coefficient blend +
          Region crossfade), single LFO (cutoff/morph/both), ZOutputStage
          toggle, per-block + per-sample coefficient interpolation.
================================================================================
*/
