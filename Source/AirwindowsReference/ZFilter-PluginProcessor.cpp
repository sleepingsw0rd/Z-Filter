...
Features: 4 filter types (LP/HP/BP/NT), morph (coefficient blend),
          single LFO (cutoff/morph/both), ZOutputStage toggle,
          per-block + per-sample coefficient interpolation.
================================================================================
*/
